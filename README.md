...
**The optional ESP32 component** (`apps_espidf/didcot_dac/main/main.c`) runs the MCP4728 quad-channel DAC service from `champaign`, integrated here for self-contained pipeline evaluation without external equipment.
